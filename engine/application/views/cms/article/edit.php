                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <a href="http://images.indonesiasatu.co/filemanager/dialog.php?type=1&&fldr=/&field_id=selected_image&relative_url=1&iframe=1&crossdomain=1&width=80%&height=80%"  rel="prettyPhoto" class="btn btn-default"><i class="fa fa-upload"></i> Browse Image</a>
                                    </div>
                                </div>
                            </div>
