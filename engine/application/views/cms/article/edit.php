                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <a href="http://images.indonesiasatu.co/filemanager/dialog.php?editor=0tinymce&type=1&lang=en_EN&popup=1&crossdomain=1&field_id=selected_image&relative_url=1&iframe=true&width=80%&height=80%"  rel="prettyPhoto" class="btn btn-default"><i class="fa fa-upload"></i> Browse Image</a>
                                    </div>
                                </div>
                            </div>
